                ...
                dynamic "not_statement" {
                  ...
                  content {
                    statement {
                      ...
                      # AND not_statement size_constraint_statement
                      dynamic "size_constraint_statement" {
                        for_each = length(lookup(not_statement.value, "size_constraint_statement", {})) == 0 ? [] : [lookup(not_statement.value, "size_constraint_statement", {})]
                        content {
                          dynamic "field_to_match" {
                            for_each = length(lookup(size_constraint_statement.value, "field_to_match", {})) == 0 ? [] : [lookup(size_constraint_statement.value, "field_to_match", {})]
                            content {
